# Generated by Powerlevel10k configuration wizard on 2024-06-20 at 20:52 IST.
...
# 2 lines, solid, right frame, dark-ornaments, sparse, few icons, concise,
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_USER}@${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
